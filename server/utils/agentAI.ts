...
export const AGENT_REGISTRY: AgentProfile[] = [
  ...
  { type: 'business_planner', name: 'Business Model Planner', specialty: 'modelos de negocio, business model canvas, pricing, revenue streams, análisis de mercado y competencia, unit economics' },
  { type: 'growth_planner', name: 'Growth Planner', specialty: 'estrategias de crecimiento, growth loops, funnels de adquisición (AARRR), retención, experimentos A/B, referidos, canales' },
  { type: 'viral_content', name: 'Viral Content Generator', specialty: 'contenido viral para redes (TikTok, Reels, Shorts, X), hooks, tendencias, storytelling corto, calendarios de contenido' },
  { type: 'pricing', name: 'Pricing Strategist', specialty: 'estrategia de precios, tiers y planes, pricing psicológico, benchmarks de competencia, elasticidad, descuentos, monetización y willingness-to-pay' },
