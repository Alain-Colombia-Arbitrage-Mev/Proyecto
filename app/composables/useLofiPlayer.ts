...
const stations: LofiStation[] = [
  ...
  },
  {
    id: 'sleep-chill-lofi',
    focus: true,
    name: 'Sleep Chill Lofi',
    emoji: '🌙',
    url: '',
    color: '#A78BFA',
    fallbackUrls: [],
    type: 'youtube',
    youtubeId: 'JD-kMIpDfnY',
    tracks: [
      { title: 'Lofi Hip Hop · Sleep and Chill', artist: 'Lofi Girl', duration: 'LIVE' },
    ],
  },
  {
    id: 'study-hiphop-flow',
    focus: true,
    name: 'Study Hiphop',
    emoji: '📚',
    url: '',
    ...
    tracks: [
      { title: 'Lofi Hip Hop · Study and Relax', artist: 'Chillhop Music', duration: 'LIVE' },
    ],
  },
  {
    id: 'coding-lofi',
    ...
    fallbackUrls: [],
    type: 'youtube',
    youtubeId: 'ByZGu229-yA',
    tracks: [
      { title: '24/7 Beats · Study, Relax and Code', artist: 'Lofi Hiphop Mix', duration: 'LIVE' },
    ],
  },
  {
    id: 'neo-soul-focus',
    ...
    fallbackUrls: [],
    type: 'youtube',
    youtubeId: 'THh4fT0O7IY',
    tracks: [
      { title: 'Deep Focus & Energy · R&B Lofi Hiphop', artist: 'Lofi Soul', duration: 'LIVE' },
    ],
  },
  {
    id: 'smooth-study-lofi',
    focus: true,
    name: 'Smooth Lofi',
    emoji: '🌊',
    url: '',
    ...
    fallbackUrls: [],
    type: 'youtube',
    youtubeId: 'X9L277oGLlo',
    tracks: [
      { title: 'Smooth Beats · Study, Sleep and Relax', artist: 'Lofi Radio', duration: 'LIVE' },
    ],
  },
  {
    id: 'coffee-shop-lofi',
    ...
    fallbackUrls: [],
    type: 'youtube',
    youtubeId: 'blAFxjhg62k',
    tracks: [
      { title: 'Coffee Shop Radio · Chill Lo-Fi & Jazzy Beats', artist: 'Coffee Shop Radio', duration: 'LIVE' },
    ],
  },
  // === CLASSICAL ===
  {
