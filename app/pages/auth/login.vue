  ...
  <div>
    <NuxtLayout name="auth">
      <div class="animate-fade-up">
        ...
        <p class="text-sm text-gray-500 mb-8">Inicia sesión para continuar con tus proyectos</p>
...
async function handleLogin() {
  ...
  try {
    ...
    // Wait for @nuxtjs/supabase to sync session cookie to server
    await new Promise(r => setTimeout(r, 500))
    await router.push('/')
  } catch (e: any) {
    errorMsg.value = e.message || 'Email o contraseña incorrectos'
  }
}
