<template>
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 animate-fade-up">

      <!-- ═══════ ROW 1 ═══════ -->

      <!-- Welcome Card — spans 2 cols, PlanIQ clean style -->
      ...
      <!-- Quick Stats — PlanIQ style with large numbers -->
      ...
      <!-- Anti-Procrastination Coach — spans 2 cols, tall -->
      <div class="md:col-span-2 md:row-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-md transition-all duration-200">
      ...
      <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200">
        ...
        <div class="text-center">
          <div class="text-3xl font-bold text-gray-900 tabular-nums font-mono mb-2">
            {{ pomodoroDisplay }}
          </div>
          <p class="text-[10px] text-gray-400 mb-3">{{ pomodoroPhase === 'work' ? 'Tiempo de enfoque' : 'Descanso' }}</p>
          <div class="flex items-center justify-center gap-2">
            <button
              ...
              :class="pomodoroRunning ? 'bg-red-100 text-red-600 hover:bg-red-200' : 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200'"
            >
              <UIcon :name="pomodoroRunning ? 'i-heroicons-pause' : 'i-heroicons-play'" class="w-4 h-4" />
            </button>
            <button
              @click="resetPomodoro"
              class="w-9 h-9 rounded-full bg-gray-100 text-gray-500 hover:bg-gray-200 flex items-center justify-center transition-all cursor-pointer"
            >
      ...
      <!-- Recent Projects — spans 2 cols, PlanIQ style with progress -->
